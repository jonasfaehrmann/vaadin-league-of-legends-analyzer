...
public class SummonerSpellService extends RiotService<SummonerSpellList> {
	...
	public SummonerSpellService(RestTemplateBuilder restTemplateBuilder) throws RiotApiException {
		...
		sumSpellList = api.getDataSummonerSpellList(platform.EUW, locale, null, false, SpellListTags.ALL);
		...
		public List<SummonerSpell> getSumSpell() throws RiotApiException {
			...
			@Override
			public List<SummonerSpellList> findAllBySummonerName(String name) throws RiotApiException {
