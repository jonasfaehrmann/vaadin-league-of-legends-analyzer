...
//		orderService.addHistoryItem(order, comment, SecurityUtils.getCurrentAccount(accountService));
...
//			l.setCaption(formatTimestamp(historyItem) + " by " + historyItem.getCreatedBy().getEmail());
//			l.setWidth("100%");
